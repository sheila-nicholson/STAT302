...
-   full model: LogMass \* Instar \* Fgp
    -   reduced model:

        ```         
        LogMass * Instar + LogMass * Fgp + Instar * Fgp
        ```
...
-   summarize from this we would not remove Instar\*Fgp

-   low p-value = there is strong evidence that we should not remove the
    interaction that we did
...
-   summarize from this we would not remove the LogMass\*Fgp
...
-   therefore we should remove LogMass \* Instar
